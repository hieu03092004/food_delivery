    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          bottom: TabBar(
            isScrollable: true,
            tabs: _orderStatusLabels.values.map((label) => Tab(text: label)).toList(),
          ),
        ),
        body: _isLoading
            ? Center(child: CircularProgressIndicator())
            : TabBarView(
          children: _orderStatusLabels.keys.map((statusKey) {
            final orders = _orderMap.values
                .where((order) =>
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Chip(
                                label: Text(
                                  _orderStatusLabels[order.status] ?? 'Không rõ',
